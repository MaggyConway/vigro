...
?>
<div class="bx-filter col-md-4 col-lg-3 catalog_section__filter">
	<div class="bx-filter-section container-fluid">

		<div class="catalog_section__sort mobile_filter_header">
			<div class="col-auto d-flex align-items-center">
				<div>Фильтр (<span class="mobile_filter_count">0</span>)</div>
				<div class="mobile_filter_panel--close"></div>
			</div>
		</div>
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="col-lg-12 bx-filter-parameters-box bx-active bx-filter__range">
							<span class="bx-filter-container-modef"></span>
							<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="bx-filter-parameters-box-hint">Цена, руб<?//=$arItem["NAME"]?> <i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i></span></div>
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container m-0">
									...
									<div class="row justify-content-between align-items-center flex-nowrap p-0 m-0">
										<div class="bx-filter-parameters-box-container-block bx-left range_input">
										...
										<div class="bx-filter-parameters-box-container-block bx-right range_input">
											<div class="bx-filter-input-container">
												<input
													class="max-price"
													type="text"
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="col-lg-12 bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								case "A"://NUMBERS_WITH_SLIDER
									?>
									<div class="col-12 bx-filter__range">
										<div class="bx-ui-slider-track-container">
											<div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
												<?
												$precision = $arItem["DECIMALS"]? $arItem["DECIMALS"]: 0;
										...
										<div class="row justify-content-between align-items-center flex-nowrap m-0">
											<div class="bx-filter-parameters-box-container-block bx-left range_input">
												<div class="bx-filter-input-container">
													<input
														class="min-price"
			...
			<div class="row bx-filter__btns filter_block">
