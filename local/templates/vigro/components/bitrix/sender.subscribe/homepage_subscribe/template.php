...
<section class="subscribe">
	<div class="container">
                <!-- <form class="row gx-0 subscribe__form">
                    <h2>Хочешь узнавать об&nbsp;акциях и&nbsp;новинках?</h2>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" class="row gx-0 subscribe__form">
		<?=bitrix_sessid_post()?>
		...
		<!-- <div class="row p-0 m-0 align-items-center"> -->
			...
			<input type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
			...
			<button class="btn btn--light" id="bx_subscribe_btn_<?=$buttonId?>">
