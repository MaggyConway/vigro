...
<!-- <div class="col-12 col-md-8 col-lg-9 catalog_section__grid">
    <div class="catalog_item new">
        <a href="./element.html">
            <img
                src="./assets/images/catalog_item1.png"
    ...
    <div class="catalog_item hit">
        <a href="./element.html">
            <img
                src="./assets/images/catalog_item2.png"
                alt="catalog_item_image"
            />
        </a>
        <p class="catalog_item__title">
    ...
    <div class="catalog_item">
        <a href="javascript:void(0);">
            <img
                src="./assets/images/catalog_item3.png"
                alt="catalog_item_image"
            />
        </a>
        <p class="catalog_item__title">
    ...
    <div class="catalog_item">
        <a href="javascript:void(0);">
            <img
                src="./assets/images/catalog_item4.png"
                alt="catalog_item_image"
            />
        </a>
        <p class="catalog_item__title">
...
<div class="product-item catalog_item">
	<? if ($itemHasDetailUrl) : ?>
		<a class="product-item-image-wrapper" href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>" data-entity="image-wrapper">
		<? else : ?>
			<span class="product-item-image-wrapper" data-entity="image-wrapper">
			<? endif; ?>
			<span class="product-item-image-original" id="<?= $itemIds['PICT'] ?>" style="background: url('<?= $image ?>') no-repeat center center; background-size: contain !important;">
			</span><?
			if ($item['LABEL']) {
			?>
...
<? endif; ?>
<div class="product-item-title card_title_block">
	...
	if (!empty($price)) {
		if ($arParams['PRODUCT_DISPLAY_MODE'] === 'N' && $haveOffers) {
			...
			echo '<p class="card_item_price">' . $price['PRINT_RATIO_PRICE'] . '</p>';
		}

	}
	else if (!empty($item['PRICES']['BASE']['PRINT_VALUE']))
	{
		echo '<p class="card_item_price">' . $item['PRICES']['BASE']['PRINT_VALUE'] . '</p>';
	}
	?>
